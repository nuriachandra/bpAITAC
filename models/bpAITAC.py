...
class BPcmHead(nn.Module):
    ...
    def __init__(self, seq_length:int, n_celltypes:int, input_channels:int, pool_size:List[int], n_reps:int, conv_width:int, bin_size:int, scalar_head_fc_layers:int, scalar_head_hidden_layer:int, profile_out_len:int, off_by_two:bool):
        """
        ...
        self.profile_prediction = ProfileHead(in_channels, n_celltypes, bin_size=bin_size, profile_out_len=self.profile_out_len, off_by_two=off_by_two) # TODO should be 250 for most up-to-date bias models
