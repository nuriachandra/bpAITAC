...
# running it on a model with the protein free dna model 
...
# running it on a model with the protein free dna model 
# python prep_get_bias_logits.py --onehot_npz /data/nchand/mm10/mm10ImmGenATAC1219.peak_matched1000bp_onehot-ACGT_alignleft.npz --saved_bias_model /homes/gws/nchand/MostafaviLab/results/BPbi/BP160_L0_1/complete/01-02-2025.18.39/best_model --out_path /data/nchand/ImmGen/mouse/BPprofiles1000/bias/BP160_L0_1_deprotinated_mm10ImmGenATAC1219.peak_matched1000bp_onehot-ACGT_alignleft.npz
# running on protein free DNA model 
# python prep_get_bias_logits.py --onehot_npz /data/nchand/mm10/mm10ImmGenATAC1219.peak_matched1000bp_onehot-ACGT_alignleft.npz --saved_bias_model /homes/gws/nchand/MostafaviLab/results/BPbi/BP106_L9_-1/complete/11-02-2024.14.49/best_model --out_path /data/nchand/ImmGen/mouse/BPprofiles1000/bias/BP106_L9_-1_deprotinated_mm10ImmGenATAC1219.peak_matched1000bp_onehot-ACGT_alignleft.npz


# running it on a model trained from closed regions
# python prep_get_bias_logits.py --onehot_npz /data/nchand/mm10/mm10ImmGenATAC1219.peak_matched1000bp_onehot-ACGT_alignleft.npz --saved_bias_model /homes/gws/nchand/MostafaviLab/results/BPbi/BP105_L0_1/complete/11-02-2024.14.45/best_model --out_path /data/nchand/ImmGen/mouse/BPprofiles1000/bias/BP105_L0_1_closed_mm10ImmGenATAC1219.peak_matched1000bp_onehot-ACGT_alignleft.npz